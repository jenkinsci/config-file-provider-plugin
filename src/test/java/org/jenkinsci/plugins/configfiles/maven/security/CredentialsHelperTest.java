...
public class CredentialsHelperTest {
    ...
    public void testIfServerAuthIsReplacedWithinSettginsXml() throws Exception {
        ...
        List<BaseStandardCredentials> credentials = new ArrayList<BaseStandardCredentials>();
        credentials.add(new UsernamePasswordCredentialsImpl(CredentialsScope.SYSTEM, "my.server", "peter", PWD, "some desc"));
        credentials.add(new UsernamePasswordCredentialsImpl(CredentialsScope.SYSTEM, "encoded_pwd", "dan", PWD_2, "some desc"));
